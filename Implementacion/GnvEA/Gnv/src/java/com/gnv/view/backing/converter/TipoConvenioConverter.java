...
@ManagedBean
@RequestScoped
public class TipoConvenioConverter implements Converter {

    @EJB
    private TipoConvenioFacadeLocal tipoConvenioFacade;

    public TipoConvenioConverter()
    {
    }
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value)
    {
        ...
        try
        {
            ...
            TipoConvenio tc = tipoConvenioFacade.find(i);
            return tc;
        } catch (Exception e)
        {
    ...
    {
        if (!(value instanceof TipoConvenio))
        {
            return null;
        }
        return String.valueOf(((TipoConvenio) value).getId());
